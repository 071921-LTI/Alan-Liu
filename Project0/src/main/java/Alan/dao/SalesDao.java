...
public class SalesDao {
	...
	public boolean AddSales(int iid,int cid, int n) throws SQLException
	{
		...
		{
			log.error("Fail to add sales" + e.fillInStackTrace());
			e.printStackTrace();
		}finally
		{
			conn.close();
	...
	public ArrayList<Sales> ViewMyPurchase(int id) throws SQLException{
		...
		try
		{
			...
			log.error("Fail to View Purchase"+ e.fillInStackTrace());
			e.printStackTrace();
		}
		finally {
			conn.close();
	...
	public ArrayList<Sales> AllPayments() throws SQLException{
		...
		try
		{
			...
			log.error("Fail to print all payments"+ e.fillInStackTrace());
			e.printStackTrace();
		}
		finally {
			conn.close();
	...
	public ArrayList<Sales> WeeklyPayments() throws SQLException
	{
		...
		{
			log.error("Fail to calculate weekly Payment"+ e.fillInStackTrace());
			e.printStackTrace();
		}finally {
			conn.close();
		}
